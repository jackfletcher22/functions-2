...
//const findGrape = function (arr) {
  //  for (let i=o; i<arr.length; i++) {
    //    if (arr[i].color === "purple") {
            //return console.log(`This fruit with index ${arr.indexOf(arr[i])} is a grape`)
...
// CODE HERE
const firstFunction = (parameter1, parameter2) => {
...
greeting ("Jack", "fletcher",(fullName) =>
...
const pricesPlusTax = (prices, cb) => {
    for(let i=0; i<prices.length; i++) {
        totalCost.push(prices[i] + (prices[i] * .20))
    }
cb(totalCost)    
}
/* 
